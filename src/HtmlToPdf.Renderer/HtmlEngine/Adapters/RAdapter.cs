...
using HtmlToPdf.Renderer.HtmlEngine.Core.Handlers;
using HtmlToPdf.Renderer.HtmlEngine.Core.Utils;

namespace HtmlToPdf.Renderer.HtmlEngine.Adapters
{
    /// <summary>
    ...
    public abstract class RAdapter
    {
        ...
        public RImage GetLoadingImage()
        {
            if (_loadImage == null)
            {
                var stream = typeof(HtmlRendererUtils).Assembly.GetManifestResourceStream("HtmlToPdf.Renderer.HtmlEngine.Core.Utils.ImageLoad.png");
                if (stream != null)
        ...
        public RImage GetLoadingFailedImage()
        {
            if (_errorImage == null)
            {
                var stream = typeof(HtmlRendererUtils).Assembly.GetManifestResourceStream("HtmlToPdf.Renderer.HtmlEngine.Core.Utils.ImageError.png");
                if (stream != null)
